...
Yahia.Model.deferredStrike  = false;
Yahia.Model.discardCascades = false;
Yahia.Model.forkMode        = false;
Yahia.Model.passPartial     = false;
Yahia.Model.passTurn        = 0;
Yahia.Model.sharedPieces    = false;
Yahia.Model.recycleCaptures = false;
Yahia.Model.smartFrom       = false;
Yahia.Model.smartTo         = false;
Yahia.Model.showGoals       = true;
Yahia.Model.showCaptures    = true;
Yahia.Model.showMoves       = true;
Yahia.Model.showHints       = false;
Yahia.Model.stalemateDraw   = false;
Yahia.Model.showBlink       = true;
Yahia.Model.chessCapturing  = true;
Yahia.Model.progressive     = false;
Yahia.Model.progressiveUrl  = null;
Yahia.Model.silent          = false;
Yahia.Model.showDrops       = -1;
Yahia.Model.dragNdrop       = true;
Yahia.Model.detectLoops     = false;
Yahia.Model.advisorWait     = null;
Yahia.Model.remapPromote    = false;
Yahia.Model.passForcedDraw  = true;
Yahia.Model.animateRedo     = false;
Yahia.Model.completePartial = false;
Yahia.Model.zrfCompatible   = false;
Yahia.Model.showLose        = false;

Yahia.Model.checkVersion = function(design, name, value, selector) {  
  if (!_.isUndefined(selector) && (selector != Yahia.Model.getSetupSelector())) {
      return;
  }
  if (name == "z2j") {
     ...
     if (name == "show-lose") {
         if (value == "false") Yahia.Model.showLose = false;
     }
     if (name == "complete-partial") {
         if (value == "true") Yahia.Model.completePartial = true;
     }
     if (name == "animate-redo") {
         if (value == "false") Yahia.Model.animateRedo = false;
         if (value == "true")  Yahia.Model.animateRedo = true;
     }
     if (name == "promote-dialog") {
         if (value == "remap") Yahia.Model.remapPromote = true;
     }
     if (name == "advisor-wait") {
         Yahia.Model.advisorWait = +value * 1000;
     }
     if (name == "detect-loops") {
         if (value == "true")    Yahia.Model.detectLoops = true;
     }
     if (name == "drag-n-drop") {
         if (value == "false")   Yahia.Model.dragNdrop = false;
     }
     if (name == "show-drops") {
         if (!_.isNaN(value))    Yahia.Model.showDrops = +value;
         if (value == "false")   Yahia.Model.showDrops = 0;
         if (value == "true")    Yahia.Model.showDrops = -1;
         if (value == "all")     Yahia.Model.showDrops = -2;
     }
     if (name == "progressive-levels") {
         Yahia.Model.progressive = (value == "true");
         if (value == "silent") {
             Yahia.Model.progressive = true;
             Yahia.Model.silent      = true;
         }
         if ((value != "silent") && (value != "true")) {
             Yahia.Model.progressive = true;
             Yahia.Model.progressiveUrl = value;
         }
     }
     if (name == "show-blink") {
         Yahia.Model.showBlink = (value == "true");
     }
     if (name == "show-captures") {
         Yahia.Model.showCaptures = (value == "true");
     }
     if (name == "shared-pieces") {
         Yahia.Model.sharedPieces = (value == "true");
     }
     if (name == "show-moves-list") {
         Yahia.Model.showMoves = (value == "true");
     }
     if (name == "highlight-goals") {
         Yahia.Model.showGoals = (value == "true");
     }
     if (name == "smart-moves") {
         if ((value == "from") || (value == "true")) {
            Yahia.Model.smartFrom = true;
         }
         if ((value == "to") || (value == "true")) {
            Yahia.Model.smartTo = true;
         }
     }
     if ((name == "recycle-captures") && (value == "true")) {
         Yahia.Model.recycleCaptures = true;
     }
     if ((name == "discard-cascades") && (value == "true")) {
         Yahia.Model.discardCascades = true;
     }
     if ((name == "pass-partial") && (value == "true")) {
         Yahia.Model.passPartial = true;
     }
     if ((name == "pass-turn") && (value == "true")) {
         Yahia.Model.passTurn = 1;
     }
     if ((name == "pass-turn") && (value == "forced")) {
         Yahia.Model.passTurn = 2;
     }
     if (name == "moves-limit") {
         Yahia.Model.movesLimit = value;
     }
     if ((name == "show-hints") && (value == "false")) {
         Yahia.Model.showHints = false;
     }
     if ((name == "stalemate-draw") && (value == "true")) {
         Yahia.Model.stalemateDraw = true;
     }
  }
}

Yahia.Model.checkOption = function(design, name, value) {
  if (design.options[name] == value) {
      return true;
  }
}

Yahia.Model.ZRF_JUMP      = 0;
Yahia.Model.ZRF_IF        = 1;
Yahia.Model.ZRF_FORK      = 2;
Yahia.Model.ZRF_FUNCTION  = 3;
Yahia.Model.ZRF_IN_ZONE   = 4;
Yahia.Model.ZRF_GET_FLAG  = 5;
Yahia.Model.ZRF_SET_FLAG  = 6;
Yahia.Model.ZRF_GET_PFLAG = 7;
Yahia.Model.ZRF_SET_PFLAG = 8;
Yahia.Model.ZRF_GET_ATTR  = 9;
Yahia.Model.ZRF_SET_ATTR  = 10;
Yahia.Model.ZRF_PROMOTE   = 11;
Yahia.Model.ZRF_MODE      = 12;
Yahia.Model.ZRF_ON_BOARDD = 13;
Yahia.Model.ZRF_ON_BOARDP = 14;
Yahia.Model.ZRF_PARAM     = 15;
Yahia.Model.ZRF_LITERAL   = 16;
Yahia.Model.ZRF_VERIFY    = 20;
Yahia.Model.ZRF_SET_POS   = 21;
Yahia.Model.ZRF_NAVIGATE  = 22;
Yahia.Model.ZRF_OPPOSITE  = 23;
Yahia.Model.ZRF_FROM      = 24;
Yahia.Model.ZRF_TO        = 25;
Yahia.Model.ZRF_CAPTURE   = 26;
Yahia.Model.ZRF_FLIP      = 27;
Yahia.Model.ZRF_END       = 28;

Yahia.Model.ZRF_NOT       = 0;
Yahia.Model.ZRF_IS_EMPTY  = 1;
Yahia.Model.ZRF_IS_ENEMY  = 2;
Yahia.Model.ZRF_IS_FRIEND = 3;
Yahia.Model.ZRF_IS_LASTF  = 4;
Yahia.Model.ZRF_IS_LASTT  = 5;
Yahia.Model.ZRF_MARK      = 6;
Yahia.Model.ZRF_BACK      = 7;
Yahia.Model.ZRF_PUSH      = 8;
Yahia.Model.ZRF_POP       = 9;
Yahia.Model.ZRF_IS_PIECE  = 10;
Yahia.Model.ZRF_CREATE    = 11;

Yahia.Model.commands = {};

Yahia.Model.commands[Yahia.Model.ZRF_JUMP] = function(gen, param) {
   return param - 1;
}

Yahia.Model.commands[Yahia.Model.ZRF_IF] = function(gen, param) {
...
Yahia.Model.commands[Yahia.Model.ZRF_FORK] = function(gen, param) {
   var g = gen.clone();
   g.cmd += param - 1;
   gen.board.addFork(g);
   return 0;
...
Yahia.Model.commands[Yahia.Model.ZRF_FUNCTION] = function(gen, param) {
...
Yahia.Model.commands[Yahia.Model.ZRF_IN_ZONE] = function(gen, param) {
...
Yahia.Model.commands[Yahia.Model.ZRF_GET_FLAG] = function(gen, param) {
   gen.stack.push(gen.getValue(param, -1));
   return 0;
}

Yahia.Model.commands[Yahia.Model.ZRF_SET_FLAG] = function(gen, param) {
   if (gen.stack.length == 0) {
       return null;
   }
   value = gen.stack.pop();
...
Yahia.Model.commands[Yahia.Model.ZRF_GET_PFLAG] = function(gen, param) {
   if (gen.pos === null) {
       return null;
   }
...
Yahia.Model.commands[Yahia.Model.ZRF_SET_PFLAG] = function(gen, param) {
   if (gen.pos === null) {
       return null;
   }
   if (gen.stack.length == 0) {
...
Yahia.Model.commands[Yahia.Model.ZRF_GET_ATTR] = function(gen, param) {
   if (gen.pos === null) {
       return null;
   }
...
Yahia.Model.commands[Yahia.Model.ZRF_SET_ATTR] = function(gen, param) {
   if (gen.pos === null) {
       return null;
   }
   if (gen.stack.length == 0) {
...
Yahia.Model.commands[Yahia.Model.ZRF_PROMOTE] = function(gen, param) {
...
Yahia.Model.commands[Yahia.Model.ZRF_MODE] = function(gen, param) {
   gen.mode = param;
   return 0;
}

Yahia.Model.commands[Yahia.Model.ZRF_ON_BOARDD] = function(gen, param) {
   var player = gen.board.player;
   var pos = gen.pos;
   if (pos === null) {
       return null;
...
Yahia.Model.commands[Yahia.Model.ZRF_ON_BOARDP] = function(gen, param) {
...
Yahia.Model.commands[Yahia.Model.ZRF_PARAM] = function(gen, param) {
   var value = gen.params[param];
   gen.stack.push(value);
   return 0;
}

Yahia.Model.commands[Yahia.Model.ZRF_LITERAL] = function(gen, param) {
   gen.stack.push(param);
   return 0;
}

Yahia.Model.functions = {};

Yahia.Model.functions[Yahia.Model.ZRF_VERIFY] = function(gen) {
   if (gen.stack.length == 0) {
       return null;
   }
   var f = gen.stack.pop();
...
Yahia.Model.functions[Yahia.Model.ZRF_SET_POS] = function(gen) {
   if (gen.stack.length == 0) {
       return null;
   }
...
Yahia.Model.functions[Yahia.Model.ZRF_NAVIGATE] = function(gen) {
   if (gen.stack.length == 0) {
       return null;
   }
...
Yahia.Model.functions[Yahia.Model.ZRF_OPPOSITE] = function(gen) {
   if (gen.stack.length == 0) {
       return null;
   }
   var dir = gen.stack.pop();
...
Yahia.Model.functions[Yahia.Model.ZRF_FROM] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
...
Yahia.Model.functions[Yahia.Model.ZRF_TO] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
   if (_.isUndefined(gen.piece)) {
   ...
   if (Yahia.Model.chessCapturing && !_.isUndefined(gen.cover) && !_.isUndefined(gen.from)) {
   ...
   delete gen.from;
   delete gen.piece;
   if (Yahia.Model.detectLoops && (gen.pos !== null)) {
       if (!gen.notLooped()) {
...
Yahia.Model.functions[Yahia.Model.ZRF_CAPTURE] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
   if (gen.getPiece(gen.pos) === null) {
...
Yahia.Model.functions[Yahia.Model.ZRF_FLIP] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
   if (gen.getPiece(gen.pos) === null) {
...
Yahia.Model.functions[Yahia.Model.ZRF_END] = function(gen) {
   var board = gen.board;
   if (gen.generated) {
       if (gen.moveType == 2) {
...
Yahia.Model.functions[Yahia.Model.ZRF_NOT] = function(gen) {
   if (gen.stack.length == 0) {
       return null;
   }
   var f = gen.stack.pop();
...
Yahia.Model.functions[Yahia.Model.ZRF_IS_EMPTY] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
...
Yahia.Model.functions[Yahia.Model.ZRF_IS_PIECE] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
   if (gen.stack.length == 0) {
...
Yahia.Model.functions[Yahia.Model.ZRF_CREATE] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
   if (gen.stack.length == 0) {
...
Yahia.Model.isFriend = function(piece, player) {
   if (piece === null) return false;
   return (piece.player == player);
}

Yahia.Model.functions[Yahia.Model.ZRF_IS_ENEMY] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
   var piece  = gen.getPiece(gen.pos);
   ...
   var player = gen.board.player;
   gen.stack.push(!Yahia.Model.isFriend(piece, player));
   return 0;
}

Yahia.Model.functions[Yahia.Model.ZRF_IS_FRIEND] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
   var piece  = gen.getPiece(gen.pos);
...
Yahia.Model.functions[Yahia.Model.ZRF_IS_LASTF] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
...
Yahia.Model.functions[Yahia.Model.ZRF_IS_LASTT] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
...
Yahia.Model.functions[Yahia.Model.ZRF_MARK] = function(gen) {
   if (gen.pos === null) {
       return null;
   }
   gen.setMark();
...
Yahia.Model.functions[Yahia.Model.ZRF_BACK] = function(gen) {
   var pos = gen.getMark();
   if (pos !== null) {
      gen.pos = pos;
   } else {
...
Yahia.Model.functions[Yahia.Model.ZRF_PUSH] = function(gen) {
   gen.marks.push(gen.pos);
   return 0;
}

Yahia.Model.functions[Yahia.Model.ZRF_POP] = function(gen) {
...
if (!_.isUndefined(Array.indexOf)) {
   Yahia.find = function(array, value) {
...
if (!_.isUndefined(Int32Array)) {
   Yahia.int32Array = function(array) {
...
Yahia.Model.posToString = function(pos, design) {
   if (_.isUndefined(design)) {
       design = Yahia.Model.getDesign();
   }
...
Yahia.Model.stringToPos = function(name, design) {
   if (_.isUndefined(design)) {
       design = Yahia.Model.getDesign();
   }
   var pos = Yahia.find(design.positionNames, name);
   if (pos >= 0) {
       return pos;
   } else {
       return null;
...
Yahia.Model.zupdate = function(value, piece, pos) {
  return value;
}

Yahia.Model.hupdate = function(value, piece, pos) {
  return value;
}

Yahia.Model.zplayer = function(value, player) {
  return value;
}

Yahia.Model.hplayer = function(value, player) {
  return value;
}
...
Yahia.Model.getDesign = function() {
  if (_.isUndefined(Yahia.Model.design)) {
      Yahia.Model.design = new ZrfDesign();
  }
  return Yahia.Model.design;
}
...
ZrfDesign.prototype.reserve = function(player, piece, cnt, selector) {
  ...
  var o = Yahia.find(this.playerNames, player);
  var t = Yahia.find(this.pieceNames, piece);
  if ((o < 0) || (t < 0)) {
      this.failed = true;
  } else {
...
ZrfDesign.prototype.setup = function(player, piece, pos, selector, attrs) {
  ...
  if (_.isArray(pos)) {
      _.each(pos, function(p) {
         this.setup(player, piece, Yahia.Model.stringToPos(p, this));
      }, this);
      return;
  }
  var o = Yahia.find(this.playerNames, player);
  ...
  if ((o < 0) || (t < 0)) {
      ...
      var board = Yahia.Model.getInitBoard();
      var piece = Yahia.Model.createPiece(t, o);
...
ZrfDesign.prototype.goal = function(n, player, piece, pos) {
  ...
  this.goals[o].push({
      num: n,
      piece: Yahia.find(this.pieceNames, piece),
      positions: pos
  });
}

Yahia.Model.getPieceTypes = function(piece) {
  return [ piece.type ];
}
...
ZrfDesign.prototype.getTemplate = function(ix) {
  if (_.isUndefined(this.templates[ix])) {
      this.templates[ix] = Yahia.Model.createTemplate();
  }
...
ZrfDesign.prototype.checkVersion = function(name, value, selector) {
  ...
  Yahia.Model.checkVersion(this, name, value);
}

ZrfDesign.prototype.checkOption = function(name, value) {
  return Yahia.Model.checkOption(this, name, value);
}

ZrfDesign.prototype.getPieceType = function(name) {
  var r = Yahia.find(this.pieceNames, name);
  if (r < 0) {
      return null;
  }
  return r;
...
ZrfDesign.prototype.getDirection = function(name) {
  var r = Yahia.find(this.dirs, name);
  if (r < 0) {
      return null;
  }
  return r;
...
ZrfDesign.prototype.addPlayer = function(player, symmetries, selector) {
  if (!_.isUndefined(selector) && (selector != Yahia.Model.getResourceSelector())) return;
  var ix = this.playerNames.length;
  if (this.playerNames.length == 0) {
      ix = 0;
      this.playerNames.push("opposite");
  }
  this.players[ix] = Yahia.int32Array(symmetries);
...
ZrfDesign.prototype.addPosition = function(name, links, selector) {
  ...
  this.positions.push(Yahia.int32Array(links));
}
...
ZrfDesign.prototype.findDirection = function(from, to) {
  ...
  var dir = Yahia.find(this.positions[from], to - from);
...
ZrfDesign.prototype.getZone = function(name) {
  var zone = Yahia.find(this.zoneNames, name);
...
ZrfDesign.prototype.addZone = function(name, player, positions, selector) {
  ...
  this.zones[zone][player] = Yahia.int32Array(positions);
}
...
ZrfDesign.prototype.inZone = function(zone, player, pos) {
  if (!_.isUndefined(this.zones[zone])) {
      if (!_.isUndefined(this.zones[zone][player])) {
          return Yahia.find(this.zones[zone][player], pos) >= 0;
      }
  }
  return false;
}
...
Yahia.Model.createTemplate = function() {
  return new ZrfMoveTemplate();
}

ZrfMoveTemplate.prototype.addCommand = function(name, param) {
  if (!_.isUndefined(Yahia.Model.commands[name])) {
      if (_.isUndefined(Yahia.Model.cache)) {
          Yahia.Model.cache = [];
      }
      if (_.isUndefined(Yahia.Model.cache[name])) {
          Yahia.Model.cache[name] = [];
      }
      var offset = param;
      if (_.isUndefined(Yahia.Model.cache[name][offset])) {
          Yahia.Model.cache[name][offset] = function(x) {
              return (Yahia.Model.commands[name])(x, offset);
          }
      }
      this.commands.push(Yahia.Model.cache[name][offset]);
  }
}
...
Yahia.Model.createGen = function(template, params, design, mode, serial, sound) {
  if (_.isUndefined(design)) {
      design = Yahia.Model.getDesign();
  }
  var r = new ZrfMoveGenerator(design, mode, serial, sound);
  r.template = template;
  r.params   = Yahia.int32Array(params);
  return r;
}
...
ZrfMoveGenerator.prototype.copy = function(template, params) {
  var r = Yahia.Model.createGen(template, params, this.design, this.move.mode, this.serial, this.move.sound);
...
var isCaptured = function(move, pos) {
  if (!Yahia.Model.deferredStrike) return false;
...
Yahia.Model.getMark = function(gen) {
  if (gen.marks.length == 0) {
      return null;
  } else {
...
ZrfMoveGenerator.prototype.getMark = function() {
  return Yahia.Model.getMark(this);
}

Yahia.Model.setMark = function(gen) {
  if (gen.marks.length > 0) {
      gen.marks.pop();
  }
  if (gen.pos !== null) {
...
Yahia.Model.getPiece = function(gen, pos) {
  if (gen.parent !== null) {
...
ZrfMoveGenerator.prototype.getPiece = function(pos) {
  return Yahia.Model.getPiece(this, pos);
}
...
Yahia.Model.isLastFrom = function(pos, board) {
...
ZrfMoveGenerator.prototype.isLastFrom = function(pos) {
  ...
  return Yahia.Model.isLastFrom(pos, this.board);
}

Yahia.Model.isLastTo = function(pos, board) {
...
ZrfMoveGenerator.prototype.isLastTo = function(pos) {
  ...
  return Yahia.Model.isLastTo(pos, this.board);
}

Yahia.Model.getValueInternal = function(aThis, name, pos) {
  return null;
}
...
ZrfMoveGenerator.prototype.getValue = function(name, pos) {
  ...
  return Yahia.Model.getValueInternal(this, name, pos);
}
...
Yahia.Model.getAttrInternal = function(gen, name, pos) {
  return null;
}
...
ZrfMoveGenerator.prototype.getAttr = function(name, pos) {
  ...
  return Yahia.Model.getAttrInternal(this, name, pos);
}
...
Yahia.Model.createPiece = function(type, player) {
  if (_.isUndefined(Yahia.Model.cachePiece)) {
      Yahia.Model.cachePiece = [];
  }
  if (_.isUndefined(Yahia.Model.cachePiece[player])) {
      Yahia.Model.cachePiece[player] = [];
  }
  if (_.isUndefined(Yahia.Model.cachePiece[player][type])) {
      Yahia.Model.cachePiece[player][type] = new ZrfPiece(type, player);
  }
  return Yahia.Model.cachePiece[player][type];
}

Yahia.Model.pieceToString = function(piece) {
  return piece.getOwner() + " " + piece.getType();
}

ZrfPiece.prototype.toString = function() {
  return Yahia.Model.pieceToString(this);
}

ZrfPiece.prototype.getType = function() {
  var design = Yahia.Model.getDesign();
...
ZrfPiece.prototype.promote = function(type) {
  return Yahia.Model.createPiece(type, this.player);
}
...
ZrfPiece.prototype.changeOwner = function(player) {
  if (this.player == player) {
      ...
      return Yahia.Model.createPiece(this.type, player);
  }
}

ZrfPiece.prototype.flip = function() {
  var design = Yahia.Model.getDesign();
  return Yahia.Model.createPiece(this.type, design.nextPlayer(this.player));
}

Yahia.Model.BuildDesign = function(design) {}

Yahia.Model.InitGame = function() {
  var design = Yahia.Model.getDesign();
...
function ZrfBoard(game) {
  ...
  this.forks    = [];
  this.turn     = 0;
  this.player   = Yahia.Model.getDesign().currPlayer(this.turn);
  this.changed  = [];
  this.parent   = null;
  this.values   = [];
  this.zSign    = Yahia.Model.zplayer(0, this.player);
  this.hSign    = Yahia.Model.hplayer(0, this.player);
  this.level    = 0;
}
...
Yahia.Model.checkGoals = function(design, board, player) {
  var r = null;
...
ZrfBoard.prototype.checkGoals = function(design, player) {
  ...
  return Yahia.Model.checkGoals(design, this, player);
}

Yahia.Model.setup = function(board) {}

ZrfBoard.prototype.setup = function(view, initialize) {
  if (initialize) {
      Yahia.Model.setup(this);
  }
  view.clear();
  _.each(_.keys(this.pieces), function(pos) {
...
Yahia.Model.getInitBoard = function() {
  if (_.isUndefined(Yahia.Model.board)) {
      var design = Yahia.Model.getDesign();
      Yahia.Model.board = new ZrfBoard(Yahia.Model);
      Yahia.Model.board.reserve = design.reserve;
  }
  return Yahia.Model.board;
}
...
ZrfBoard.prototype.addFork = function(gen) {
  if (!_.isUndefined(Yahia.Model.movesLimit)) {
      if (this.forks.length >= Yahia.Model.movesLimit) {
          this.failed = true;
          return;
      }
  }
...
ZrfBoard.prototype.setPiece = function(pos, piece) {
  if (!_.isUndefined(this.pieces[pos])) {
      ...
      this.zSign = Yahia.Model.zupdate(this.zSign, op, pos);
      this.hSign = Yahia.Model.hupdate(this.hSign, op, pos);
  }
  if (piece === null) {
     delete this.pieces[pos];
  } else {
     this.pieces[pos] = piece;
     this.zSign = Yahia.Model.zupdate(this.zSign, piece, pos);
     this.hSign = Yahia.Model.hupdate(this.hSign, piece, pos);
  }
}
...
Yahia.Model.PostActions = function(board) {
...
Yahia.Model.Extension = function(board) {}

Yahia.Model.getPartList = function(board, gen) {
  return [ gen.lastt ];
}
...
var addPrior = function(priors, mode, gen) {
  ...
  if (gen.design.modes.length > 0) {
      ix = Yahia.find(gen.design.modes, mode);
      if (Yahia.Model.zrfCompatible && (ix < 0)) {
...
var CompleteMove = function(board, gen, cover, serial) {
  ...
  var positions = Yahia.Model.getPartList(board, gen);
  if (!Yahia.Model.passPartial) { var t = 2; } 
      else { var t = 1; }
  while (positions.length > 0) {
       ...
       if ((piece !== null) && (Yahia.Model.sharedPieces || Yahia.Model.isFriend(piece, board.player))) {
...
ZrfBoard.prototype.generateInternal = function(callback, cont, cover, serial) {
  ...
  if ((this.moves.length == 0) && !design.failed && (this.player > 0)) {
      ...
      _.chain(_.keys(this.pieces))
       .filter(function(pos)  
          { return !_.isUndefined(cover) ||
                   Yahia.Model.sharedPieces || 
                   Yahia.Model.isFriend(this.pieces[pos], this.player); 
          }, this)
       .each(function(pos) {
           var piece = this.pieces[pos];
           _.chain(design.pieces[piece.type])
            ...
            .each(function(move) {
                var g = Yahia.Model.createGen(move.template, move.params, this.game.design, move.mode, sn++, move.sound);
                if (!_.isUndefined(cover)) {
                    g.cover  = cover;
                    g.serial = serial;
                }
      ...
      if (_.isUndefined(cover)) {
          _.each(design.allPositions(), function(pos) {          
            _.chain(_.range(design.pieces.length))
             .filter(function(tp) { return !Yahia.Model.noReserve(this, tp); }, this)
             .each(function(tp) {
      ...
      Yahia.Model.Extension(this);
      if (cont) {
          Yahia.Model.CheckInvariants(this);
          Yahia.Model.PostActions(this);
          if (Yahia.Model.passTurn == 1) {
              this.moves.push(new ZrfMove());
          }
          if (Yahia.Model.passTurn == 2) {
              if (this.moves.length == 0) {
                  this.moves.push(new ZrfMove());
              }
          }
...
Yahia.Model.GetCover = function(design, board) {
...
ZrfBoard.prototype.getCover = function(design) {
  return Yahia.Model.GetCover(design, this);
}
...
Yahia.Model.decReserve = function(board, piece) {
...
Yahia.Model.incReserve = function(board, piece) {
  if (!_.isUndefined(board.reserve[piece.type])) {
      if (!_.isUndefined(board.reserve[piece.type][piece.player])) {
          board.reserve[piece.type][piece.player]++;
      }
...
Yahia.Model.noReserve = function(board, piece) {
...
ZrfBoard.prototype.movePiece = function(move, from, to, piece) {
  ...
  if (Yahia.find(this.changed, from) < 0) {
      this.setPiece(from, null);
  }
  this.setPiece(to, piece);
...
ZrfBoard.prototype.dropPiece = function(move, pos, piece) {
  this.lastt = pos;
  Yahia.Model.decReserve(this, piece);
  this.setPiece(pos, piece);
  this.changed.push(pos);
}

ZrfBoard.prototype.capturePiece = function(move, pos) {
  if (Yahia.Model.recycleCaptures) {
      var piece = this.getPiece(pos);
          if (piece != null) {
              Yahia.Model.incReserve(this, piece);
          }
  }
  this.setPiece(pos, null);
...
Yahia.Model.Done = function(design, board) {}
...
ZrfBoard.prototype.apply = function(move) {
  ...
  r.zSign  = Yahia.Model.zplayer(r.zSign, this.player);
  r.hSign  = Yahia.Model.hplayer(r.hSign, this.player);
  r.player = design.currPlayer(r.turn);
  r.level  = this.level + 1;
  move.applyAll(r);
  r.move = move;
  r.zSign  = Yahia.Model.zplayer(r.zSign, r.player);
  r.hSign  = Yahia.Model.hplayer(r.hSign, r.player);
  return r;
}
...
Yahia.Model.createMove = function(mode, sound) {
  var r = new ZrfMove(mode);
  r.sound = sound;
  return r;
}

Yahia.Model.compareMove = function(move, notation) {
...
ZrfMove.prototype.getZ = function() {
  if (_.isUndefined(this.zSign)) {
      _.each(this.actions, function(a) {
          if (a[2] === null) return;
          if (a[0] !== null) {
              this.zSign = Yahia.Model.zupdate(this.zSign, a[2][0], a[0][0]);
          }
          if (a[1] !== null) {
              this.zSign = Yahia.Model.zupdate(this.zSign, a[2][0], a[1][0]);
          }
      }, this);
  }
  return this.zSign;
  ...
  r.actions = _.chain(this.actions)
   .filter(function(action) {
        if ((action[0] !== null) && (action[1] !== null) && o) {
            if (Yahia.Model.discardCascades) {
                o = false;
            }
            return true;
        }
        if (Yahia.Model.forkMode || (Math.abs(action[3]) < level)) {
            return true;
        }
        return false;
    })
...
Yahia.Model.moveToString = function(move, part) {
  ...
  _.chain(move.actions)
   ...
   .each(function(action) {
       if (l !== action[0][0]) {
           ...
           r = r + Yahia.Model.posToString(action[0][0]);
       }
       r = r + " - ";
       r = r + Yahia.Model.posToString(action[1][0]);
       l = action[1][0];
    });
  _.chain(move.actions)
   .filter(n)
...
ZrfMove.prototype.toString = function(part) {
  return Yahia.Model.moveToString(this, part ? part : 0 );
}
      ...
      this.actions.push([ null, null, [{
          exec: function() {
             if (_.isUndefined(delay)) {
                 Yahia.Controller.play(ix);
             } else {
                 _.delay(Yahia.Controller.play, delay, ix);
             }
          }
      }], part]);
  }
...
Yahia.Model.getX = function(pos) {
  return pos % Yahia.Model.WIDTH;
}

Yahia.Model.getY = function(pos) {
  return (pos / Yahia.Model.WIDTH) | 0;
}

Yahia.Model.continue = function(design, board, str, result) {
...
Yahia.Model.getSetupSelector = function(val) {
  if (_.isUndefined(Yahia.Model.setupSelector)) {
      var str = window.location.search.toString();
      var result = str.match(/[?&]selector=([^&]*)/);
      if (result) {
          Yahia.Model.setupSelector = +result[1];
      }
  }
  if (_.isUndefined(Yahia.Model.setupSelector)) {
      if (!_.isUndefined(val) && (val > 1)) {
          Yahia.Model.setupSelector = _.random(1, val);
      } else {
          Yahia.Model.setupSelector = 1;
      }
  }
  return Yahia.Model.setupSelector;
}

ZrfDesign.prototype.setupSelector = function(val) {
  Yahia.Model.getSetupSelector(val);
}

Yahia.Model.getResourceSelector = function() {
  return Yahia.Model.setupSelector;
}
